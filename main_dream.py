...
if __name__ == '__main__':
    ...
    if opt.test:
        ...
        if opt.gui:
            ...
            test_loader = DreamDataset(opt, device=device, type='test').dataloader()
        ...
        train_loader = DreamDataset(opt, device=device, type='train').dataloader()
        ...
        if opt.gui:
            ...
            valid_loader = DreamDataset(opt, device=device, type='val', downscale=1).dataloader()
